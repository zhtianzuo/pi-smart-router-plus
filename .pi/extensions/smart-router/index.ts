...
// Plus layer (Risk Guard, Planner Read-only Guard, Depletion Guard) — re-exported
// so extension consumers and tests use the public facade only.
export {
  ...
  sanitizeDetail,
  type BalanceEntry,
  type BalanceReasonCode,
  type BalanceStatus,
  type PlusConfig,
  type PlusCredentialPort,
